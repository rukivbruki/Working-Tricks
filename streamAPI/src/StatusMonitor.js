...
export default function StatusMonitor({fetchedPercentage, processedPercentage}) {
    ...
    return (
        <>
            <Progress
                percent={Math.floor(fetchedPercentage)} steps={20} size="large" strokeColor="#52c41a"/>
            <Result
